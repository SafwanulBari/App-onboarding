...
export const ONBOARDING_IMAGE_MODULES = [
  require('../../assets/onboarding/hero-splash.webp'),
  require('../../assets/onboarding/hero-splash-2.webp'),
  require('../../assets/onboarding/hero-splash-3.webp'),
  require('../../assets/onboarding/badge-icon-3.webp'),
];
